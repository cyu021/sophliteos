...
func Routers() *gin.Engine {
	...
	PublicGroup := Router.Group("")
	{
		...
		appRouter.InitSshRouter(PublicGroup)
	}

	PrivateGroup := Router.Group("")
	PrivateGroup.Use(middleware.AuthMiddleware())
	{
		appRouter.InitFileRouter(PrivateGroup)
		appRouter.InitContainerRouter(PrivateGroup)
		appRouter.InitCoreContainerRouter(PrivateGroup)

		appRouter.InitTerminalRouter(PrivateGroup)
