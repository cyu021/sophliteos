...
type PcieResource struct {
	...
	NetCard           []NetCard             `json:"netCard"`
	CoreComputingUnit PcieCoreComputingUnit `json:"coreComputingUnit"`
}
type Tpu struct {
...
type PcieCoreComputingUnit struct {
	Board []BoardPcie `json:"board"`
}
...
type BoardPcie struct {
	...
	TpuTotal    float64 `json:"tpuTotal"`
	TpuUsed     float64 `json:"tpuUsed"`
	MemTotal    float64 `json:"memTotal"`
	MemUsed     float64 `json:"memUsed"`
}
...
type Board struct {
	...
	Number      int       `json:"number"`
	Ip          string    `json:"ip"`
	SSMVersion  string    `json:"ssmVersion"`
}
