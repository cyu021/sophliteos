...
import { AlarmRecordParams, LogFunctionInfo } from './model/index';
...
enum Api {
  ...
  logFunc = '/device/operRecord/func',
}
...
export function getLogFunctionInfo() {
  return defHttp.get<LogFunctionInfo>({ url: Api.logFunc });
}
